...
bit different, as will be explained later. Since the data must be on secure
servers, we can't use GitHub workflows nor upload any data for public access.
That means we can't use a continuous release process like a GitHub workflow.
